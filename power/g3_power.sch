...
F 1 "5.23k" H 6068 3055 50  0000 L CNN
...
F 1 "30.1k" H 6068 3355 50  0000 L CNN
...
U 1 1 621AC99C
P 2625 7400
F 0 "#PWR0109" H 2625 7150 50  0001 C CNN
F 1 "GND" H 2630 7227 50  0000 C CNN
F 2 "" H 2625 7400 50  0001 C CNN
F 3 "" H 2625 7400 50  0001 C CNN
	1    2625 7400
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	1200 7200 1200 7250
Text Label 2675 6650 0    50   ~ 0
~CC_CE
Text Label 2675 6550 0    50   ~ 0
~CC_INT
Text Label 2675 6750 0    50   ~ 0
~CC_QON
...
Wire Wire Line
	10525 1850 10525 2050
Wire Wire Line
	10275 1850 10525 1850
$Comp
L Device:C C108
U 1 1 61C25B14
P 10700 2250
F 0 "C108" H 10750 2350 50  0000 L CNN
F 1 "0.1uF" H 10700 2150 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 10738 2100 50  0001 C CNN
...
U 1 1 61BA5617
P 9875 1850
F 0 "U102" H 9875 2200 50  0000 C CNN
F 1 "TPS61202DRC" H 9275 2700 50  0000 C CNN
F 2 "Package_SON:Texas_S-PVSON-N10_ThermalVias" H 9875 1400 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tps61200.pdf" H 9875 1850 50  0001 C CNN
F 4 "Voltage Regulator" H 9875 1850 50  0001 C CNN "Description"
F 5 "Texas Instruments" H 9875 1850 50  0001 C CNN "MFN"
F 6 "TPS61202DRCR" H 9875 1850 50  0001 C CNN "MFP"
F 7 "https://www.digikey.com/en/products/detail/texas-instruments/TPS61202DRCR/1908017" H 9875 1850 50  0001 C CNN "S1PL"
F 8 "296-27462" H 9875 1850 50  0001 C CNN "S1PN"
	1    9875 1850
	1    0    0    -1  
$EndComp
Wire Notes Line
	8425 550  8425 3250
Wire Notes Line
	8425 3250 11125 3250
Wire Notes Line
	11125 3250 11125 550 
Wire Notes Line
	11125 550  8425 550 
Wire Wire Line
	9475 1850 9000 1850
...
VR_PS
Wire Wire Line
	10275 1650 10350 1650
$Comp
L Device:L_Small L102
U 1 1 61F4A718
P 9875 1350
F 0 "L102" V 10060 1350 50  0000 C CNN
F 1 "2.2uH" V 9969 1350 50  0000 C CNN
F 2 "Inductor_SMD:L_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 9875 1350 50  0001 C CNN
F 3 "~" H 9875 1350 50  0001 C CNN
	1    9875 1350
	0    -1   -1   0   
$EndComp
Wire Wire Line
	9975 1350 10350 1350
Wire Wire Line
...
U 1 1 61E5E41D
P 10900 1725
F 0 "#PWR0123" H 10900 1575 50  0001 C CNN
F 1 "+5V" H 10915 1898 50  0000 C CNN
F 2 "" H 10900 1725 50  0001 C CNN
F 3 "" H 10900 1725 50  0001 C CNN
	1    10900 1725
	1    0    0    -1  
$EndComp
Wire Wire Line
	10900 1725 10900 1750
$Comp
L power:GND #PWR0108
U 1 1 61C3620A
P 10700 2475
F 0 "#PWR0108" H 10700 2225 50  0001 C CNN
F 1 "GND" H 10600 2375 50  0000 C CNN
F 2 "" H 10700 2475 50  0001 C CNN
...
Wire Wire Line
	9350 1650 9425 1650
Wire Wire Line
	10525 2050 10700 2050
Wire Wire Line
	10525 2050 10425 2050
Connection ~ 10525 2050
Wire Wire Line
	10275 1750 10700 1750
$Comp
L power:GND #PWR0136
U 1 1 620A2210
P 9975 2475
F 0 "#PWR0136" H 9975 2225 50  0001 C CNN
...
Wire Wire Line
	9350 1950 9350 2675
Wire Wire Line
	9350 2675 10425 2675
Wire Wire Line
	10425 2675 10425 2050
Connection ~ 10425 2050
Wire Wire Line
	10425 2050 10275 2050
$EndSCHEMATC
